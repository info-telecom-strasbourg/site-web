        ...
        <div class="container pt-3">
            <form action="/projets" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select @error('pole_id') is-invalid @enderror" id="pole_id" name="pole_id"
                        required>
                        ...
                        @isset($poles)
                            ...
                            @foreach ($poles as $pole)
                                <option value="{{ $pole->id }}" @if (old('pole_id') == $pole->id)
                                    selected
                    ...
                    <select class="custom-select @error('chef_projet_id') is-invalid @enderror" id="chef_projet_id"
                        ...
                        @isset($users)
                            ...
                            @foreach ($users as $user)
                                <option value="{{ $user->id }}" @if (old('chef_projet_id') == $user->id) selected
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="url" class="form-control @error('link_github') is-invalid @enderror" id="link_github"
                            name="link_github" placeholder="Lien du repository GitHub" value="{{ old('link_github') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="url" class="form-control @error('link_doc') is-invalid @enderror" id="link_doc"
                            name="link_doc" placeholder="Lien vers la documentation" value="{{ old('link_doc') }}">
