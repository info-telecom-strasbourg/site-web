            ...
            <form class="" action="/poles/cours/{{ $cours->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title"
                        value="{{ $cours->title }}" required autocomplete="title" autofocus>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control desc @error('desc') is-invalid @enderror" id="desc" name="desc" rows="5"
                        required>{{ $cours->desc }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <input type="file" id="cover" name="cover" class="@error('cover') is-invalid @enderror" accept="image/png,image/gif,image/jpeg">
                    @error('cover')
                    <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <input type="file" id="link_support_mod" name="link_support[]" accept="image/png,image/gif,image/jpeg" multiple>
                </div>
