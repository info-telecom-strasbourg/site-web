        ...
        <div class="container pt-3">
            <form action="/poles/{{ $pole->id }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <input class="form-control @error('title') is-invalid @enderror" type="text"
                            value="{{ $pole->title }}" id="title" name="title" required>
                    </div>
                </div>
                @error('title')
                ...
                <div class="form-group">
                    ...
                    <div class="control">
                        <textarea class="form-control desc @error('desc') is-invalid @enderror" id="desc" name="desc"
                            rows="10" required>{{ $pole->desc }}</textarea>
                    </div>
                </div>
                @error('desc')
                <span class="invalid-feedback" role="alert">
